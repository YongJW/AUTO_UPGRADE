...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "upgrade-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:upgrade:impl";
    private final String revision = "2015-12-21";
    private final String resourcePath = "/META-INF/yang/yang-upgrade-impl.yang";
