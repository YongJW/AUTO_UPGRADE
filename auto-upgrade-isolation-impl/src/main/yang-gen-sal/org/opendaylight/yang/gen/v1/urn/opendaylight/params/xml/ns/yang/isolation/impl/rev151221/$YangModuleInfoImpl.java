...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "isolation-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:isolation:impl";
    private final String revision = "2015-12-21";
    private final String resourcePath = "/META-INF/yang/isolation-impl.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.netconfclient.impl.rev141210.$YangModuleInfoImpl.getInstance());
