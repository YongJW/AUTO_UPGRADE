...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "Alibaba-UG-oper";
    private final String namespace = "http://alibaba.com/ns/yang/Alibaba-UG-oper";
    private final String revision = "2015-12-11";
    private final String resourcePath = "/META-INF/yang/Alibaba-UG-oper.yang";
