...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "BootCamp-UG-cfg";
    private final String namespace = "http://bootcamp.com/ns/yang/BootCamp-UG-cfg";
    private final String revision = "2015-12-11";
    private final String resourcePath = "/META-INF/yang/BootCamp-UG-cfg.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.http.bootcamp.com.ns.yang.bootcamp.ug.types.rev151211.$YangModuleInfoImpl.getInstance());
        set.add(org.opendaylight.yang.gen.v1.http.bootcamp.com.ns.yang.bootcamp.ug.isolation.rev151211.$YangModuleInfoImpl.getInstance());
