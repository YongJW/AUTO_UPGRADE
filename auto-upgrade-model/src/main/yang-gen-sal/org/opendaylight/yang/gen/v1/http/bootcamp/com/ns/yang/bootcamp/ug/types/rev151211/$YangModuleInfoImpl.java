...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "BootCamp-UG-types";
    private final String namespace = "http://bootcamp.com/ns/yang/BootCamp-UG-types";
    private final String revision = "2015-12-11";
    private final String resourcePath = "/META-INF/yang/BootCamp-UG-types.yang";
