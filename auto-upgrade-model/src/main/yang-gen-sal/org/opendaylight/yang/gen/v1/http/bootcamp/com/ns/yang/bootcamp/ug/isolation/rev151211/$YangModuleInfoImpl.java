...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "BootCamp-UG-isolation";
    private final String namespace = "http://bootcamp.com/ns/yang/BootCamp-UG-isolation";
    private final String revision = "2015-12-11";
    private final String resourcePath = "/META-INF/yang/BootCamp-UG-isolation.yang";
