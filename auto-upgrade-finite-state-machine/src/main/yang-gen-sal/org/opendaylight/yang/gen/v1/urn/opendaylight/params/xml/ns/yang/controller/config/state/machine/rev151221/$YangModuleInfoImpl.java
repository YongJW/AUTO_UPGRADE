package org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.state.machine.rev151221 ;
...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "state-machine";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:state-machine";
    private final String revision = "2015-12-21";
    private final String resourcePath = "/META-INF/yang/finite-state-machine.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.upgrade.impl.rev151221.$YangModuleInfoImpl.getInstance());
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.isolation.impl.rev151221.$YangModuleInfoImpl.getInstance());
